...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    NSURL *successURL = [NSURL URLWithString:@"tumblr391994024204840://success"];
    NSURL *cancelURL = [NSURL URLWithString:@"tumblr391994024204840://cancelled"];
    ...
    switch (indexPath.row) {
        ...
        case TMAppClientActionViewTag:
            ...
            break;
        case TMAppClientActionViewBlog:
            [TMTumblrAppClient viewBlog:@"Beergarden"];
            break;
        case TMAppClientActionViewPost:
