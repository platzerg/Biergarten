...
NSString *const kKeychainItemName1 = @"DriveSample: Google Drive";
...
- (void)awakeFromNib {
    ...
    auth = [GTMOAuth2ViewControllerTouch authForGoogleFromKeychainForName:kKeychainItemName1
                                                              clientID:clientID
...
- (IBAction)signInClicked:(id)sender {
    if (![self isSignedIn]) {
        ...
        [GTMOAuth2ViewControllerTouch removeAuthFromKeychainForName:kKeychainItemName1];
...
- (void)runSigninThenHandler:(void (^)(void))handler {
    ...
    /*
    windowController = [GTMOAuth2ViewControllerTouch controllerWithScope:kGTLAuthScopeDrive
                                                             clientID:clientID
                                                         clientSecret:clientSecret
                                                     keychainItemName:kKeychainItemName1
